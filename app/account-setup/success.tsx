...
export default function SuccessScreen() {
    ...
    const { registrationData, clearRegistrationData, getRegistrationRequest } = useRegistration();
    ...
    useEffect(() => {
        const completeRegistration = async () => {
            try {
                ...
                setError(error.message || 'There was a problem completing your registration.');
            } finally {
        ...
        return (
            <StyledSafeAreaView className="flex-1 bg-[#1a1a2e] justify-center items-center">
                ...
                <Text className="text-gray-400 mt-2 text-center px-8">
                    Please wait while we register your account. This will just take a moment.
                </Text>
            </StyledSafeAreaView>
        );
    }
