...
import { View, Text, SafeAreaView, TouchableOpacity, TextInput, Alert, ScrollView, Image, StyleSheet } from 'react-native';
import { StatusBar } from 'react-native';
import { router, useLocalSearchParams } from 'expo-router';
import { ChevronLeft, Mail, Shield, CheckCircle, Clock } from 'lucide-react-native';
    ...
    const handleResend = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                Alert.alert('Error', result.message || 'Failed to resend verification code. Please try again.');
            }
        } catch (error) {
            Alert.alert('Error', 'An unexpected error occurred. Please try again.');
                        ...
                        <View style={styles.mainContent}>
                            ...
                            <View style={styles.logoSection}>
                                ...
                                <View style={styles.subtitleContainer}>
                                    ...
                                    <View style={styles.emailContainer}>
                                        <Mail size={16} color="#FF5A5F" style={styles.emailIcon} />
                            ...
                            <View style={styles.codeSection}>
                                ...
                                {code.length === 6 && (
                                    <View style={styles.successIndicator}>
                                        ...
                                        <Text style={styles.successText}>Code entered successfully</Text>
                                    </View>
                                )}
                            </View>
                            ...
                            <View style={styles.securityNotice}>
                                ...
                                <Text style={styles.securityText}>
                                    This step helps us verify your identity and secure your account
                                </Text>
                            </View>
                        </View>
