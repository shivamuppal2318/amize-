...
import { SafeAreaView, ScrollView, View, Text, TouchableOpacity, Linking, Alert } from 'react-native';
import { router } from 'expo-router';
import { SettingsHeader } from '@/components/settings/SettingsHeader';
import {SITE_URL} from "@/lib/settings/constants";
import {ChevronRight, Download, Globe, Mail, Send, Shield, ShieldCheck, Users} from "lucide-react-native";
                ...
                <View className="px-6 pb-6 pt-4">
                    ...
                    <View className="mb-8">
                        ...
                        <Text className="text-gray-400 leading-6 mb-4">
                            At Amize, we're committed to protecting your privacy and being transparent about how we collect, use, and share your information. Here's a summary of our key privacy practices.
                        </Text>
                        ...
                        <View className="flex flex-col gap-3">
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    Alert.alert('Coming Soon', 'Data management features will be available in account settings.');
                                }}
                            >
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    Alert.alert('Coming Soon', 'Privacy settings will be available in account settings.');
                                }}
                            >
                                <View className="flex-row items-center">
                            ...
                            <TouchableOpacity
                                ...
                                activeOpacity={0.7}
                                onPress={() => {
                                    Linking.openURL('mailto:privacy@amize.com?subject=Data%20Download%20Request');
                                }}
                            >
                                <View className="flex-row items-center">
                    ...
                    <View className="bg-gradient-to-r from-pink-500/10 to-purple-500/10 rounded-2xl p-6 mt-6 border border-pink-500/20">
                        ...
                        <Text className="text-gray-300 leading-5">
                            We're committed to earning and maintaining your trust through transparent privacy practices and strong data protection measures.
                        </Text>
                    </View>
                </View>
            </ScrollView>
