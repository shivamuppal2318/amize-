                ...
                <Animated.View style={[
                    ...
                    <View style={styles.header}>
                        ...
                        <View style={styles.headerIcon}>
                            <SettingsIcon size={28} color="#FF5A5F"/>
                        </View>
                    </View>
                    ...
                    <View style={styles.settingsContainer}>
                        ...
                        <View style={styles.settingsSection}>
                            ...
                            <View style={styles.sectionContent}>
                                ...
                                />
                                <EnhancedMenuItem
                                    icon={<Shield size={22} color="#FF5A5F"/>}
                                    label="Security"
                                    subtitle="Password, two-factor authentication"
                                    onPress={() => handleNavigate('/settings/security')}
                                />
                                <EnhancedMenuItem
                                    icon={<Star size={22} color="#FF5A5F"/>}
                                    label="Premium"
                        ...
                        <View style={styles.settingsSection}>
                            ...
                            <View style={styles.sectionContent}>
                                ...
                                />
                                <EnhancedMenuItem
                                    icon={<Download size={22} color="#FF5A5F"/>}
                                    label="Data & Storage"
                        ...
                        <View style={styles.settingsSection}>
                            ...
                            <View style={styles.sectionContent}>
                                <EnhancedMenuItem
                                    icon={<HelpCircle size={22} color="#FF5A5F"/>}
                                    label="Help Center"
                                    subtitle="FAQs, contact support"
                                    onPress={() => handleNavigate('/settings/help-center')}
                                />
                                <EnhancedMenuItem
                                    icon={<FileText size={22} color="#FF5A5F"/>}
                        ...
                        {/* Danger Zone */}
                        <View style={styles.settingsSection}>
                            <Text style={[styles.sectionTitle, styles.dangerSectionTitle]}>Account Actions</Text>
                            <View style={styles.sectionContent}>
                                <EnhancedMenuItem
                                    icon={<LogOut size={22} color="#FF5A5F"/>}
                                    label="Sign Out"
