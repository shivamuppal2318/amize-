...
import {Plus, MoreVertical, WifiOff, RotateCcw, MessageCircle, MessageSquare} from 'lucide-react-native';
...
const MessagesHeader: React.FC<MessagesHeaderProps> = ({ isConnected, onRetry }) => (
                    ...
                    {!isConnected && (
                        ...
                        >
                            <View style={[styles.iconContainer, styles.retryIcon]}>
                                <RotateCcw size={UI.ICON_SIZE.MEDIUM} color={COLORS.error} />
                            </View>
                        </TouchableOpacity>
                    )}
                    <TouchableOpacity
