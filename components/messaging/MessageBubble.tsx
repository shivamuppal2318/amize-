...
const MessageBubble: React.FC<MessageBubbleProps> = ({
    ...
    const getBubbleRadius = () => {
        ...
        return {
            borderTopLeftRadius: isMe && position !== 'first' ? smallRadius : baseRadius,
            borderTopRightRadius: !isMe && position !== 'first' ? smallRadius : baseRadius,
            borderBottomLeftRadius: isMe && position !== 'last' && position !== 'single' ? smallRadius : baseRadius,
            borderBottomRightRadius: !isMe && position !== 'last' && position !== 'single' ? smallRadius : baseRadius,
        };
    };
