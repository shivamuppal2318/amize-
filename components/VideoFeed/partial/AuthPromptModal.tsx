        ...
        switch (action.toLowerCase()) {
            case 'like':
                return {
                    ...
                    description: 'Sign up to show your appreciation and discover more content you\'ll love.',
                };
            case 'comment':
                return {
            ...
            case 'share':
                return {
                    ...
                    description: 'Sign up to share videos with your friends and followers.',
                };
            case 'report':
                return {
                    icon: <Flag size={48} color="#FF5A5F" />,
                    title: 'Report content',
                    description: 'Sign up to help us maintain a safe and positive community.',
                };
            default:
                return {
                    icon: <Heart size={48} color="#FF5A5F" />,
                    title: 'Join the community',
                    description: 'Sign up to interact with videos and connect with creators.',
                };
        }
    };
