...
const CommentsModal: React.FC<CommentsModalProps> = ({visible, onClose, videoId, commentsCount, parentId, parentUsername,}) => {
    // Use our comments hook
    const {comments, loading, error, hasMore, totalComments, loadMoreComments, refreshComments, addComment, likeComment}
        = useComments({
            videoId, parentId, autoLoad: false, // We'll load when the modal becomes visible
        }
    );
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.header}>
                            ...
                            <Text style={styles.headerTitle}>
                                {totalComments === 0 && loading ? 'Loading...' : `${totalComments.toLocaleString()} Comments`}
                            </Text>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <TextInput
                                ref={inputRef}
                                style={styles.input}
                                placeholder={parentUsername ? `Reply to @${parentUsername}...` : "Add comment..."}
